...
interface Product {
  ...
  price: number;
  halfPrice?: number;
  quantity?: string;        // Renamed from 'unit'
  description?: string;
  imageUrl?: string;
  imageUrls?: string[];
  createdAt?: Timestamp;
...
const AdminPage: React.FC = () => {
        ...
        (snap) => {
          const prods: Product[] = snap.docs.map((d) => {
            ...
            return {
              ...
              quantity: data.quantity ?? "1", // default
  ...
  /* ---------- UI ---------- */
  return (
    <section className="min-h-screen bg-gradient-to-b from-orange-50 to-white p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-red-700 mb-8 text-center md:text-left">
          Admin Panel - QuickBite
        </h1>

        <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
          <h2 className="text-2xl font-semibold text-gray-800">Menu Categories</h2>
          <AddCategoryDialog />
        </div>
...
const AddProductDialog: React.FC<AddProductDialogProps> = ({ categoryId }) => {
  ...
  const resetForm = () => {
    setName(""); setPrice(undefined); setHalfPrice(undefined);
    setQuantity("1"); setDescription(""); setIsVeg(true);
        ...
        <div className="space-y-3 py-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              ...
              <div
                className="border-2 border-dashed rounded-lg p-4 flex flex-col items-center justify-center text-center cursor-pointer hover:border-red-500"
    ...
    <DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto">
      ...
      <div className="space-y-3 py-4">
        ...
        <div>
          <Label>Images</Label>
          <div
            className="border-2 border-dashed rounded-lg p-4 text-center cursor-pointer hover:border-red-500"
